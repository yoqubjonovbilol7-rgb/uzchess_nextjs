...
export default function MatchesFilter({ countryId, setCountryId, age, setAge, onClear }: Props) {
        ...
        <div className="w-[280px] flex-shrink-0 flex flex-col gap-4">
            ...
            <div className="bg-[#1A1D1F] border border-[#232627] rounded-2xl p-5">
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <div>
                        <p className="text-[#9CA3AF] text-xs uppercase tracking-wide mb-2">Yosh:</p>
                        <div className="relative">
                            <select
                                value={age}
                            ...
                            >
                                <option value="">Barchasi</option>
                                <option value="youth">Yoshlar (18 gacha)</option>
                                <option value="adult">Kattalar (18+)</option>
                                <option value="veteran">Veteranlar (60+)</option>
                            </select>
                            <svg className="absolute right-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-500 pointer-events-none" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                            </svg>
